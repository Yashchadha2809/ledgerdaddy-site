...
app = Flask(__name__)
app.secret_key = os.getenv("SECRET_KEY", "dev-change-me")  # set SECRET_KEY on Vercel
...
def home():
    if HOME_FILE.exists():
        # small cache is okay; set to 0 if you want instant refresh
...
# --- Personal Sign Up (inline HTML, no templates folder) ----------------------
...
<body class="bg-gray-50 text-gray-900">
  <div class="max-w-md mx-auto mt-16 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
    ...
    <form method="post" action="{url_for('personal_sign_up_post')}" class="grid gap-3 mt-5" autocomplete="on">
